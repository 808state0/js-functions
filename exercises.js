...
function checkDifference(x){
	return "Last night I dreampt that I ate " + x + " Taco Bell soft tacos. " 
...
var myFullName = createFullName("Michael","Anguay");
...
function eatFood(firstName,lastName,food){
	return firstName + " " + lastName + " " + "loves to eat" + " " + food + " " + "food." 
}
console.log(eatFood("Michael","Anguay","Hawaiian"));
